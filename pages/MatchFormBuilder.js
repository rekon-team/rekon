...
import Box from '../components/moveableBox';
import ToolBar from '../components/editBar';
...
export default function MatchFormBuilder({ navigation, route }){
    ...
    function addBox() {
        ...
        let newBoxes = [...boxes, {id: nextBoxId, x: 0, y: 0, width: gridSize * 2, height: gridSize * 2,  color: Colors.secondary, text: '', fontSize: 15, fontColor: Colors.primary, bold: 'normal', italic: 'normal', icon: '', iconColor: Colors.primary, iconSize: 50, page: '', functions: []}];
    ...
    return(
        <View style={{flex: 1, width: '100%', height: '100%', backgroundColor: Colors.primary}}>
            ...
            {/*<View style={{position: 'absolute', left: 0, top: 60, width: '100%', height: 50, justifyContent: 'center'}}>
