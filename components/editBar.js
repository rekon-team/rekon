    ...
    return(
        <View style={{position: 'absolute', bottom: 0, width: '100%'}}>
            <GestureDetector gesture={props.tabBarType === 0 ? props.changeTabBarType(1) : props.changeTabBarType(0)}>
                <View style={{width: '100%', height: 30, marginBottom: 0, backgroundColor: Colors.accent, zIndex: 5, alignItems:'center'}}>
                    <MaterialIcons name={props.tabBarType === 0 ? 'expand-less' : 'expand-more'} color={Colors.text} size={30}/>
                </View>
            </GestureDetector>
                ...
                {(props.tabBarType === 2 || props.tabBarType === 1 || props.tabBarType === 0) && 
                    <ScrollView style={{flex: 1}}>
                        <GestureDetector gesture={props.changeTabBarType(3)}>
                            <View style={{width: 200, height: 200, margin: 10, borderRadius: 10, backgroundColor: Colors.secondaryContainer, alignItems: 'center'}}>
                                <Text style={{fontSize: 34, color: Colors.secondary, position: 'absolute', bottom: 10}}>Button</Text>
                            </View>
                        </GestureDetector>
                    </ScrollView>
                }
                        ...
                        {(props.isAddTextPressed || props.isColorPressed || props.isIconPressed) && (
                            <GestureDetector gesture={back}>
                                <View style={buttonStyle}>
                                    <MaterialIcons name='chevron-left' size={55} color={Colors.secondary}/>
                                </View>
                            </GestureDetector>
                        )}

                        <View style={{position: 'absolute', left: 205, top: 10, width: 5, height: 55, backgroundColor: Colors.secondaryContainer, borderRadius: 10}} />
                        
                        {!props.isAddTextPressed && !props.isColorPressed && !props.isIconPressed && (
                            <>
                                <GestureDetector gesture={props.changeTabBarType(2)}>
                                    <View style={buttonStyle}>
                                        <MaterialIcons name='check' size={55} color={Colors.secondary}/>
                                    </View>
                                </GestureDetector>
                                
                                <GestureDetector gesture={undo}>
                                    <View style={buttonStyle}>
                                        <MaterialIcons name='undo' size={55} color={Colors.secondary}/>
                                    </View>
                                </GestureDetector>

                                <GestureDetector gesture={redo}>
                                    <View style={buttonStyle}>
                                        <MaterialIcons name='redo' size={55} color={Colors.secondary}/>
                                    </View>
                                </GestureDetector>

                                <ScrollView style={{position: 'absolute', left: 225, width: Dimensions.get('window').width - 225}} horizontal={true}>
                                    <GestureDetector gesture={addBox}>
                                        <View style={{...buttonStyle, marginLeft: 0}}>
                                            <MaterialIcons name='add' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>

                                    <GestureDetector gesture={resetStorage}>
                                        <View style={buttonStyle}>
                                            <MaterialIcons name='loop' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>

                                    <GestureDetector gesture={remove}>
                                        <View style={buttonStyle}>
                                            <MaterialIcons name='delete' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>

                                    <GestureDetector gesture={duplicate}>
                                        <View style={buttonStyle}>
                                            <MaterialIcons name='content-copy' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>

                                    <GestureDetector gesture={color}>
                                        <View style={buttonStyle}>
                                            <MaterialIcons name='color-lens' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>

                                    <GestureDetector gesture={addText}>
                                        <View style={buttonStyle}>
                                            <MaterialIcons name='text-fields' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>

                                    <GestureDetector gesture={addIcon}>
                                        <View style={buttonStyle}>
                                            <MaterialIcons name='add-reaction' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>

                                    <GestureDetector gesture={props.changeTabBarType(4)}>
                                        <View style={{...buttonStyle, marginRight: 10}}>
                                            <MaterialIcons name='map' size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>
                                </ScrollView>
                            </>)}
                        {props.isAddTextPressed && (
                            <ScrollView style={{marginLeft: 30, width: Dimensions.get('window').width - 95}} horizontal={true}>
                                ...
                                <GestureDetector gesture={bold}>
                                    <View style={buttonStyle}>
                                        <MaterialIcons name='format-bold' size={55} color={isBold ? Colors.accent : Colors.secondary}/>
                                    </View>
                                </GestureDetector>

                                <GestureDetector gesture={italic}>
                                    <View style={buttonStyle}>
                                        <MaterialIcons name='format-italic' size={55} color={isItalic ? Colors.accent : Colors.secondary}/>
                                    </View>
                                </GestureDetector>
                                ...
                                <GestureDetector gesture={altPurpleTextColor}>
                                    <TouchableOpacity style={{...coloringCircleStyle, backgroundColor: Colors.secondary}}/>
                                </GestureDetector>
                            </ScrollView>)}
                            ...
                            <ScrollView style={{marginLeft: 30, width: Dimensions.get('window').width - 95}} horizontal={true}>
                                ...
                                {search.length > 0 && matches.map((match, index) => (
                                    <GestureDetector gesture={changeIcon(match)} key={index}>
                                        <View style={buttonStyle}>
                                            <MaterialIcons name={match} size={55} color={Colors.secondary}/>
                                        </View>
                                    </GestureDetector>
                                ))}
                            </ScrollView>)}
                        {props.isIconPressed && props.doesIconAlreadyExist && (
                            <ScrollView style={{marginLeft: 30, width: Dimensions.get('window').width - 95}} horizontal={true}>
                                <GestureDetector gesture={changeToSearch}>
                                    <View style={{...buttonStyle, marginLeft: 0}}>
                                        <MaterialIcons name='search' size={55} color={Colors.secondary}/>
                                        </View>
                                </GestureDetector>
                ...
                {props.tabBarType === 4 && (
                    <>
                                {props.homeMapScreen && 
                                    <>
                                        <GestureDetector gesture={props.changeTabBarType(3)}>
                                            <View style={{width: 50, height: 50, position: 'absolute', top: 10, left: 10, backgroundColor: Colors.secondaryContainer, borderRadius: 10}}>
                                                <MaterialIcons name='check' size={50} color={Colors.secondary}/>
                                            </View>
                                        </GestureDetector>
                        
                                        <Text style={{fontSize: 34, color: Colors.text, position: 'absolute', top: 10, left: 70}}>Mapping</Text>
                        
                                        <Text style={{fontSize: 34, color: Colors.text, position: 'absolute', left: 10, top: 70}}>Page</Text>
                        
                                        {props.selectedBox !== null && 
                                            <GestureDetector gesture={props.openPageMapping}>
                                                <View style={{width: '95%', height: 50, position: 'absolute', left: '2.5%', top: 120, backgroundColor: Colors.secondaryContainer, borderRadius: 10}}>
                                                    {props.getSelectedBox(props.selectedBox)?.page === '' ? 
                                                        <>
                                                            <MaterialIcons name='not-interested' size={50} style={{paddingLeft: 10, color: Colors.secondary}}/>
                        
                                                            <Text style={{position: 'absolute', left: 70, top: 6.25, color: Colors.secondary, fontSize: 25}}>Stay on current page</Text>
                                                        </>
                                                    : 
                                                        <Text style={{position: 'absolute', left: 10, top: 6.25, color: Colors.secondary, fontSize: 25}}>{props.pages.find(page => page.id === props.getSelectedBox(props.selectedBox)?.page) ? props.pages.find(page => page.id === props.getSelectedBox(props.selectedBox)?.page).name : 'Error'}</Text>
                                                    }
                                                </View>
                                            </GestureDetector>
                                        }
                        
                                        <Text style={{fontSize: 34, color: Colors.text, position: 'absolute', left: 10, top: 170}}>Function</Text>
                
                                        <GestureDetector gesture={props.addFunction}>
                                            <View style={{flexDirection: 'row', height: 34, backgroundColor: Colors.secondaryContainer, marginLeft: 170, marginTop: 178.5, marginRight: 10, borderRadius: 10}}>
                                                <MaterialIcons name='add' size={34} marginLeft={20}/>
                        
                                                <Text style={{fontSize: 17, color: Colors.secondary, marginTop: 4.25, marginLeft: 10, fontWeight: 'bold'}}>Add Function</Text>
                                            </View>
                                        </GestureDetector>
                                        ...
                                        {props.selectedBox === null && 
                                            <>
                                                <View style={{width: '95%', height: 50, position: 'absolute', left: '2.5%', top: 120, backgroundColor: Colors.secondaryContainer, borderRadius: 10}}>
                                                    <Text style={{position: 'absolute', left: 10, top: 6.25, color: Colors.secondary, fontSize: 25}}>Error: No button is selected</Text>
                                                </View>
                        
                                                <View style={{width: '95%', height: 50, position: 'absolute', left: '2.5%', top: 220, backgroundColor: Colors.secondaryContainer, borderRadius: 10}}>
                                                    <Text style={{position: 'absolute', left: 10, top: 6.25, color: Colors.secondary, fontSize: 25}}>Error: No button is selected</Text>
                                                </View>
                                            </>
                                        }
                                                ...
                                                <View key={func.id} style={{flex: 1}}>
                                                    <GestureDetector gesture={props.options(func.id)}>
                                                        <View style={{width: 25, height: 50, position: 'absolute', top: 0, right: 20, zIndex: 1}}>
                                                            <View style={{position: 'absolute', right: -12.5, width: 50, height: 50, justifyContent: 'center', alignItems: 'center'}}>
                                                                <MaterialIcons name='more-vert' size={50} color={Colors.secondary}/>
                                                            </View>
                                                        </View>
                                                    </GestureDetector>
                                                    ...
                                                    {props.functionOptions && props.optionId === func.id && 
                                                        <GestureDetector gesture={props.deleteFunction(func.id)}>
                                                            <View style={{width: 100, height: 35, position: 'absolute', right: 25, top: 25, zIndex: 3, backgroundColor: Colors.secondaryContainer, borderRadius: 10, borderWidth: 5, borderColor: Colors.secondary, justifyContent: 'center', alignItems: 'center', flexDirection: 'row'}}>
                                                                <Text style={{fontSize: 17.5, color: Colors.secondary}}>Delete</Text>
                        
                                                                <MaterialIcons name='delete' size={17.5} color={Colors.secondary}/>
                                                            </View>
                                                        </GestureDetector>
                                                    }
                        
                                                    <GestureDetector gesture={props.openFunctionMapping(func.id)}>
                                                        <View style={{width: '95%', height: 50, marginLeft: '2.5%', marginBottom: 10, backgroundColor: Colors.secondaryContainer, borderRadius: 10}}>
                                                            {func.operation !== '' ? 
                                                                <Text style={{position: 'absolute', left: 10, top: 6.25, color: Colors.secondary, fontSize: 25}}>{`${func.operation === 'add' ? '+' : func.operation === 'subtract' ? '-' : ''}${func.varName === '' ? 'Function has no variable' : func.amount} ${func.varName}`}</Text>
                                                            :
                                                                <Text style={{position: 'absolute', left: 10, top: 6.25, color: Colors.secondary, fontSize: 25}}>{func.varName !== '' ? 'No operation selected' : 'Function has no variable'}</Text>
                                                            }
                                                        </View>
                                                    </GestureDetector>
                                                </View>
                                ...
                                {props.pageMapping && 
                                    <>
                                        <GestureDetector gesture={props.openHomeMapScreen}>
                                            <View style={{width: 50, height: 50, position: 'absolute', left: 10, top: 10, backgroundColor: Colors.secondaryContainer, borderRadius: 10}}>
                                                <MaterialIcons name='arrow-back' size={50} style={{color: Colors.secondary}}/>
                                            </View>
                                        </GestureDetector>
                        
                                        <Text style={{fontSize: 34, color: Colors.text, position: 'absolute', top: 10, left: 70}}>Pages</Text>
                                            ...
                                            {props.pages.map((page, index) => (
                                                <GestureDetector key={page.id} gesture={props.selectPage(props.selectedBox, page.id)}>
                                                    <View style={{
                                                        ...
                                                        <Text style={{color: Colors.secondary, fontSize: 25, marginLeft: 20}}>
                                                            {page.name}
                                                        </Text>
                                                    </View>
                                                </GestureDetector>
                                ...
                                {props.functionMapping && 
                                    <>
                                        ...
                                        <Text style={{fontSize: 34, color: Colors.text, position: 'absolute', top: 10, left: 70}}>Function</Text>
                        
                                        <ScrollView style={{marginTop: 70, marginBottom: 20}}>
                                            <Text style={{fontSize: 34, color: Colors.text, marginLeft: 10}}>Variable:     {props.functions.find(func => func.id === props.selectedFunctionId).varName}</Text>
                
                                            {props.variables.length !== 0 && <Text style={{fontSize: 17, color: Colors.secondaryContainer, marginLeft: 10}}>Existing Variables</Text>}
                                            ...
                                            {props.variables
                                                ...
                                                .map((variable, index) => (
                                                    <GestureDetector key={variable.id} gesture={props.selectVariable(variable)}>
                                                        <View style={{flex: 1, height: 50, marginLeft: 10, marginRight: 10, marginBottom: 20, justifyContent: 'center', backgroundColor: Colors.secondaryContainer, borderRadius: 10}}>
                                                            <Text style={{fontSize: 34, marginLeft: 10}}>{variable.name}</Text>
                                                        </View>
                                                    </GestureDetector>                                
                                            ))}
                        
                                            <Text style={{fontSize: 17, color: Colors.secondaryContainer, marginLeft: 10}}>New Variable</Text>
                        
                                            <View style={{width: Dimensions.get('window').width - 20, height: 50, marginLeft: 10, justifyContent: 'center', borderRadius: 10, borderWidth: 2.5, borderColor: Colors.secondaryContainer}}>
                                                <TextInput style={{color: Colors.secondaryContainer, fontSize: 34, marginLeft: 10}} defaultValue={[...props.functions].findIndex(func => func.id === props.selectedFunctionId) !== -1 ? [...props.functions][[...props.functions].findIndex(func => func.id === props.selectedFunctionId)].newVarName : ''} onChangeText={text => {
                                            ...
                                            <Text style={{fontSize: 34, color: Colors.text, marginLeft: 10}}>Operation:   {props.functions.find(func => func.id === props.selectedFunctionId).operation === 'add' ? '+' : props.functions.find(func => func.id === props.selectedFunctionId).operation === 'subtract' ? '-' : ''}</Text>
                                            ...
                                            <View style={{flexDirection: 'row', width: Dimensions.get('window').width - 20, height: 50, marginLeft: 10}}>
                                                <GestureDetector gesture={props.setFunctionOperation('add')}>
                                                    <View style={{width: Dimensions.get('window').width / 2 - 15, height: 50, backgroundColor: Colors.secondaryContainer, borderRadius: 10, alignItems: 'center', justifyContent: 'center', flexDirection: 'row'}}>
                                                        <Text style={{fontSize: 34, color: Colors.secondary}}>Add</Text>
                    
                                                        <MaterialIcons name='add' size={34} color={Colors.secondary}/>
                                                    </View>
                                                </GestureDetector>
                        
                                                <GestureDetector gesture={props.setFunctionOperation('subtract')}>
                                                    <View style={{width: Dimensions.get('window').width / 2 - 15, marginLeft: 10, height: 50, backgroundColor: Colors.secondaryContainer, borderRadius: 10, alignItems: 'center', justifyContent: 'center', flexDirection: 'row'}}>
                                                        <Text style={{fontSize: 34, color: Colors.secondary}}>Subtract</Text>
                        
                                                        <MaterialIcons name='remove' size={34} color={Colors.secondary}/>
                                                    </View>
                                                </GestureDetector>
                                            </View>
                        
                                            <Text style={{fontSize: 34, color: Colors.text, marginLeft: 10}}>Amount:   {props.functions.find(func => func.id === props.selectedFunctionId).amount}</Text>
                        
                                            <Text style={{fontSize: 17, color: Colors.secondaryContainer, marginLeft: 10}}>Input Value</Text>
                        
                                            <View style={{width: Dimensions.get('window').width - 20, height: 50, marginLeft: 10, marginBottom: 5, justifyContent: 'center', borderRadius: 10, borderWidth: 2.5, borderColor: Colors.secondaryContainer}}>
                                                <TextInput style={{color: Colors.secondaryContainer, fontSize: 34, marginLeft: 10}} inputMode='numeric' value={JSON.stringify(props.functions.find(func => func.id === props.selectedFunctionId).amount)} onChangeText={value => {
                                                    let numberValue = 0;
                                                    if (value === '') {
                                                        numberValue = 0;
                                                    } else {
...
export default function ToolBar(props){
    ...
    return( 
            ...
            <View style={{height: '50%', width: '100%', position: 'absolute', bottom: 0, zIndex: 3}}>
