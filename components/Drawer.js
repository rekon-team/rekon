...
export default function StyledDrawer(props) {
    ...
    let userRole = "Admin"; //Placeholder
    const [currentMode, setCurrentMode] = useState('Admin'); //Placeholder
        ...
        <View style={{flex: 1}}>
            <DrawerContentScrollView {...props} contentContainerStyle={{backgroundColor: Colors.secondary, height: '100%'}}>
                {currentMode == 'Admin' ? (<>
                    ...
                    <DrawerItem {...props} label={Lang.hamburger_menu.scout_mode} focused={false} labelStyle={styles.drawerItemText} style={styles.drawerItem} inactiveBackgroundColor={Colors.tabSelected} onPress={() => {currentMode == 'Admin' ? setCurrentMode('Scout') : currentMode == 'Scout' ? setCurrentMode('Admin') : console.log('uh oh')}} icon={() => (<MaterialIcons name="swap-horiz" size={Dimensions.get('window').height * 0.03 / Dimensions.get('window').fontScale} color={Colors.text} />)} />
                    ...
                    <DrawerItem {...props} label={userName} focused={false} labelStyle={styles.userProfileText} style={styles.userProfile} inactiveBackgroundColor={Colors.tabSelected} /* PLACEHOLDER   onPress={() => props.navigation.navigate('Profile')}*/ icon={/*PLACEHOLDER*/ () => (<MaterialIcons name="person" size={Dimensions.get('window').height * 0.045 / Dimensions.get('window').fontScale} color={Colors.text} />)} />
                    {userRole == 'Admin' && (<DrawerItem {...props} label={Lang.hamburger_menu.admin_mode} focused={false} labelStyle={styles.drawerItemText} style={styles.drawerItem} inactiveBackgroundColor={Colors.tabSelected} onPress={() => {currentMode == 'Admin' ? setCurrentMode('Scout') : currentMode == 'Scout' ? setCurrentMode('Admin') : console.log('uh oh')}} icon={() => (<MaterialIcons name="swap-horiz" size={Dimensions.get('window').height * 0.03 / Dimensions.get('window').fontScale} color={Colors.text} />)} />)}

                    <View style={styles.divider} />

                    {/*<DrawerItem {...props} label={Lang.hamburger_menu.analyze} focused={props.state.index == props.state.routes.findIndex(i => i.name == "Analyze")} labelStyle={styles.drawerItemText} style={styles.drawerItem} activeBackgroundColor={Colors.divider} inactiveBackgroundColor={Colors.tabSelected} /* PLACEHOLDER onPress={() => props.navigation.navigate('Analyze')}  icon={() => (<MaterialIcons name="timeline" size={Dimensions.get('window').height * 0.03 / Dimensions.get('window').fontScale} color={Colors.text} />)} />
                    <DrawerItem {...props} label={Lang.hamburger_menu.pick_list} focused={props.state.index == props.state.routes.findIndex(i => i.name == "PickList")} labelStyle={styles.drawerItemText} style={styles.drawerItem} activeBackgroundColor={Colors.divider} inactiveBackgroundColor={Colors.tabSelected} /* PLACEHOLDER onPress={() => props.navigation.navigate('PickList')}  icon={() => (<MaterialIcons name="playlist-add-check" size={Dimensions.get('window').height * 0.03 / Dimensions.get('window').fontScale} color={Colors.text} />)} />

                    <View style={styles.divider} /> */}

                    <DrawerItem {...props} label={Lang.hamburger_menu.assignments} focused={props.state.index == props.state.routes.findIndex(i => i.name == "Assignments")} labelStyle={styles.drawerItemText} style={styles.drawerItem} activeBackgroundColor={Colors.divider} inactiveBackgroundColor={Colors.tabSelected} onPress={() => props.navigation.navigate('Assignments')} icon={() => (<MaterialIcons name="article" size={Dimensions.get('window').height * 0.03 / Dimensions.get('window').fontScale} color={Colors.text} />)} />
